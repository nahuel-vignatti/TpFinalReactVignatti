...
export default [
  ...
  },
  {
    ...
    name: "Impatiens",
    descripcion:
      "Originaria de regiones del este de África, India y China; la Impatiens Walleriana o planta Alegría tiene una fisionomía sumamente reconocible. Más allá de sus tallos carnosos, su principal seña de identidad son sus flores en tonos variados, tanto en lo que se refiere a color como a intensidad. A pesar de que su diseño es sencillo, con un tono diferente en torno al pistilo, su principal atractivo radica en que podemos disfrutar de flores durante casi todo el año. Su nombre, Alegría, no es en vano ¡se debe justamente a este detalle!",
    img: produ4,
    precio: 900,
    stock: 3,
    category: "sombra",
